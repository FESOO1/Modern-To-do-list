...
addButton.addEventListener('click', e => {
    ...
    // DELETING THE TODO CONTAINER USING DELETE BUTTON

    const outputs = document.querySelectorAll('.output');
    const outputDeleteBtn = document.querySelectorAll('.output-delete-button');

    for (let i = 0; i < outputs.length; i++) {
        outputDeleteBtn[i].addEventListener('click', () => {
